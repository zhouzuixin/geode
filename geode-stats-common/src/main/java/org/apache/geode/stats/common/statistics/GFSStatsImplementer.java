...
public interface GFSStatsImplementer extends StatsImplementer {
  @Override
  default String getStatsImplementerType() {
    return "GFS_Stats_Implementor";
  }

  @Override
  default void initializeImplementer(StatisticsFactory factory) {
