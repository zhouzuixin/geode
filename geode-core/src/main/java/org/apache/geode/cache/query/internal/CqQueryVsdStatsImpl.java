 ...
 * @since GemFire 5.5
 */
public abstract class CqQueryVsdStatsImpl implements CqQueryVsdStats, GFSStatsImplementer {
  ...
  /** Name of the created CQs statistic */
  protected static final String CQ_INSERTS = "getNumInserts";

  /** Name of the active CQs statistic */
  protected static final String CQ_UPDATES = "getNumUpdates";

  /** Name of the stopped CQs statistic */
  protected static final String CQ_DELETES = "getNumDeletes";

  /** Name of the closed CQs statistic */
  protected static final String CQ_EVENTS = "getNumEvents";
  ...
  /**
   * Returns the current value of the "getNumInserts" stat.
   *
   * @return the current value of the "getNumInserts" stat
   */
  @Override
  ...
  /**
   * Increments the "getNumInserts" stat by 1.
   */
  @Override
  ...
  /**
   * Returns the current value of the "getNumUpdates" stat.
   *
   * @return the current value of the "getNumUpdates" stat
   */
  @Override
  ...
  /**
   * Increments the "getNumUpdates" stat by 1.
   */
  @Override
  ...
  /**
   * Returns the current value of the "getNumDeletes" stat.
   *
   * @return the current value of the "getNumDeletes" stat
   */
  @Override
  ...
  /**
   * Increments the "getNumDeletes" stat by 1.
   */
  @Override
  ...
  /**
   * Returns the current value of the "getNumEvents" stat.
   *
   * @return the current value of the "getNumEvents" stat
   */
  @Override
  ...
  /**
   * Increments the "getNumEvents" stat by 1.
   */
  @Override
